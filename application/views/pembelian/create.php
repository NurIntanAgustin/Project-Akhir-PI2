                ...
                <div class="card" style="width: 40rem; padding: 20px 20px 20px 20px; margin:auto;">
                    <div class="mt-3">
                        <div class="col-md-10 mt-3">
                            ...
                            <form action="<?= base_url('pembelian/simpanpembelian'); ?>" method="POST">
                                ...
                                <select class="form-select" name="supplier_id" aria-label="Default select example">
                                    ...
                                    <?php foreach ($allsupplier as $key => $supplier) { ?>
                        ...
                        <div class="col-md-10 mt-3">
                            ...
                            <input type="number" name="keterangan" class="form-control" id="exampleFormControlInput1" placeholder="stok-tambahan">
                            <div class="mb-3">
                                <input type="hidden" name="tgl_masuk" value="<?= date('Y-m-d') ?>">
                            </div>
                            <div class="mb-3">
