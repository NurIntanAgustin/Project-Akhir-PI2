                    ...
                    <div class="mt-3">
                        <form action="<?= base_url('supplier/simpansupplier') ?>" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="kategori" class="form-control" id="exampleFormControlInput1" placeholder="kategori">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="no_tlp" class="form-control" id="exampleFormControlInput1" placeholder="no_tlp">
                            </div>
                            <div class="mb-3">
